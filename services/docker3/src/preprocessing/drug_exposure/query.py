...
?p9 rdf:type omop:drug_type_concept_id.
...
?p20 rdf:type omop:drug_source_value.
    ?instance_owl ?p20 ?drug_source_value_1.
OPTIONAL{?drug_source_value_1 owl:sameAs ?omop_p20.
    ?omop_p20 std:domain_id ?omop_domain_p20.
      ...
      ?omop_p20 std:concept_code ?drug_source_value.}
?p21 rdf:type omop:drug_source_concept_id.
    ?instance_owl ?p21 ?drug_source_concept_id_1.
OPTIONAL{?drug_source_concept_id_1 owl:sameAs ?omop_p21.
...
OPTIONAL{?instance_owl ?p22 ?route_source_value_1.}
OPTIONAL{?route_source_value_1 owl:sameAs ?omop_p22.
    ?omop_p22 std:domain_id ?omop_domain_p22.
      FILTER(?omop_domain_p22="Route")
      ?omop_p22 std:concept_code ?route_source_value.}
OPTIONAL{?p23 rdf:type omop:dose_unit_source_value.
    ?instance_owl ?p23 ?dose_unit_source_value_1.
    ?dose_unit_source_value_1 owl:sameAs ?omop_p23.
    ?omop_p23 std:domain_id ?omop_domain_p23.
      FILTER(?omop_domain_p23="Unit")
      ?omop_p23 std:concept_code ?dose_unit_source_value.}
}
        """
    return query
