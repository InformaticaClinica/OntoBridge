...
OPTIONAL{?p13 rdf:type omop:admission_source_concept_id.
    ...
    ?omop_p13 std:domain_id ?omop_domain_p13.
      ...
      ?admission_source_concept_id_uri std:concept_id ?admission_source_concept_id_uri.}
