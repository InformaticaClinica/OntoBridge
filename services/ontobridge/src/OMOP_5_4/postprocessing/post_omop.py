import pandas as pd
from src.OMOP_5_4.postprocessing.drug_exposure.post_drug_exposure import post_drug_exposure
from src.OMOP_5_4.postprocessing.person.post_person import post_person 
from src.OMOP_5_4.postprocessing.death.post_death import post_death
from src.OMOP_5_4.postprocessing.observation.post_observation import post_observation 
from src.OMOP_5_4.postprocessing.measurement.post_measurement import post_measurement
from src.OMOP_5_4.postprocessing.condition_occurrence.post_condition_occurrence import post_condition_occurrence
from src.OMOP_5_4.postprocessing.visit_occurrence.post_visit_occurrence import post_visit_occurrence
from src.OMOP_5_4.postprocessing.procedure_occurrence.post_procedure_occurrence import post_procedure_occurrence
from src.OMOP_5_4.postprocessing.visit_detail.post_visit_detail import post_visit_detail
from src.OMOP_5_4.postprocessing.device_exposure.post_device_exposure import post_device_exposure
from src.OMOP_5_4.postprocessing.observation_period.post_observation_period import post_observation_period
from datetime import datetime
now = datetime.now()
timestamp_str = now.strftime("%Y_%m_%d_%H_%M_%S")

def post_OMOP_5_4(read_folder, write_folder):
