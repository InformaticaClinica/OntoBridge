...
OPTIONAL{?p13 rdf:type omop:visit_admitted_from_concept_id.
...
OPTIONAL{?p15 rdf:type omop:visit_occurrence_discharged_to_concept_id.
    ?instance_owl ?p15 ?discharged_to_concept_id_1.
    ?discharged_to_concept_id_1 owl:sameAs ?omop_p15.
    ?omop_p15 std:domain_id ?omop_domain_p15.
      ...
      ?omop_p15 std:standard_concept_id ?discharged_to_concept_id_uri.
      ?discharged_to_concept_id_uri std:concept_id ?discharged_to_concept_id.}
OPTIONAL{?p16 rdf:type omop:visit_occurrence_discharged_to_source_value.
    ?instance_owl ?p16 ?discharged_to_source_value_1.
    ?discharged_to_source_value_1 owl:sameAs ?omop_p16.
    ?omop_p16 std:domain_id ?omop_domain_p16.
      ...
      ?omop_p16 std:concept_code ?discharged_to_source_value.}
