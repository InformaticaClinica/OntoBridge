...
OPTIONAL{?p15 rdf:type omop:procedure_end_date.
    ?instance_owl ?p15 ?procedure_end_date.}
OPTIONAL{?p16 rdf:type omop:procedure_end_datetime.
    ?instance_owl ?p16 ?procedure_end_datetime.}
