from utils.config_utils import LOGGING_CONFIG, FUSEKI_URL, FUSEKI_DB_NAME, PREPROCESSED_TABLES, POSTPROCESSED_TABLE
...
from src.MIMIC_IV.preprocessing.send_query import get_query_MIMIC_IV
from src.MIMIC_IV.postprocessing.post_mimic import post_MIMIC_IV
...
def execute_chosen_model(chosen_model):
    ...
    model_to_functions = {
        ...
        'MIMIC_IV': (get_query_MIMIC_IV, post_MIMIC_IV)
    }

    get_query, post_processing = model_to_functions[chosen_model]
    load_owl_fuseki(FUSEKI_URL, "./data/fuseki_files/", FUSEKI_DB_NAME)
