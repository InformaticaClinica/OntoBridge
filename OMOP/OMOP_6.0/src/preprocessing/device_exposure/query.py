...
?p8 rdf:type omop:device_type_concept_id.
...
?p14 rdf:type omop:device_source_value.
    ?instance_owl ?p14 ?device_source_value_1.
OPTIONAL{?device_source_value_1 owl:sameAs ?omop_p14.
    ?omop_p14 std:domain_id ?omop_domain_p14.
      FILTER(?omop_domain_p14="Device" || ?omop_p14 = <http://ontoar.clinic.cat/ontologias/standard_concepts.owl#OMOP_0>)
      ?omop_p14 std:concept_code ?device_source_value.}
?p15 rdf:type omop:device_source_concept_id.
    ?instance_owl ?p15 ?device_source_concept_id_1.
OPTIONAL{?device_source_concept_id_1 owl:sameAs ?omop_p15. 
