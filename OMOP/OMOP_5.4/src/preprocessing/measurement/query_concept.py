...
?p7 rdf:type omop:measurement_type_concept_id.
...
?p10 rdf:type omop:measurement_value_as_concept_id.
    ?instance_owl ?p10 ?value_as_concept_id_1.
    ?value_as_concept_id_1 owl:sameAs ?omop_p10.
    ?omop_p10 std:domain_id ?omop_domain_p10.
      FILTER(?omop_domain_p10="Meas Value" || ?omop_p10 = <http://ontoar.clinic.cat/ontologias/standard_concepts.owl#OMOP_0>)
      ?omop_p10 std:standard_concept_id ?value_as_concept_id_uri.
...
?p17 rdf:type omop:measurement_source_value.
    ?instance_owl ?p17 ?measurement_source_value_1.
OPTIONAL{?measurement_source_value_1 owl:sameAs ?omop_p17.
    ?omop_p17 std:domain_id ?omop_domain_p17.
      FILTER(?omop_domain_p17="Measurement" || ?omop_p17 = <http://ontoar.clinic.cat/ontologias/standard_concepts.owl#OMOP_0>)
      ?omop_p17 std:concept_code ?measurement_source_value.}
?p18 rdf:type omop:measurement_source_concept_id.
    ?instance_owl ?p18 ?measurement_source_concept_id_1.
OPTIONAL{?measurement_source_concept_id_1 owl:sameAs ?omop_p18.
...
OPTIONAL{?p19 rdf:type omop:unit_source_value.
    ...
    ?unit_source_value_1 owl:sameAs ?omop_p19.
    ?omop_p19 std:domain_id ?omop_domain_p19.
      FILTER(?omop_domain_p19="Unit")
      ?omop_p19 std:concept_code ?unit_source_value.}
