...
SELECT ?visit_detail_id ?person_id ?visit_detail_concept_id ?visit_detail_start_date ?visit_detail_start_datetime ?visit_detail_end_date ?visit_detail_end_datetime ?visit_detail_type_concept_id ?provider_id ?care_site_id ?visit_detail_source_value ?visit_detail_source_concept_id ?admitted_source_concept_id ?admitted_from_source_value ?discharged_to_source_value ?discharged_to_concept_id ?preceding_visit_detail_id ?visit_detail_parent_id ?visit_occurrence_id
WHERE {
...
OPTIONAL{?p11 rdf:type omop:visit_detail_source_value.
    ?instance_owl ?p11 ?visit_detail_source_value_1.
    ?visit_detail_source_value_1 owl:sameAs ?omop_p11.
    ?omop_p11 std:domain_id ?omop_domain_p11.
      FILTER(?omop_domain_p11="Visit")
      ?omop_p11 std:concept_code ?visit_detail_source_value.}
OPTIONAL{?p12 rdf:type omop:visit_detail_source_concept_id.
    ?instance_owl ?p12 ?visit_detail_source_concept_id_1.
    ?visit_detail_source_concept_id_1 owl:sameAs ?omop_p12.
    ?omop_p12 std:domain_id ?omop_domain_p12.
      FILTER(?omop_domain_p12="Visit")
      ?omop_p12 std:concept_id ?visit_detail_source_concept_id.}
OPTIONAL{?p13 rdf:type omop:admitted_source_concept_id.
    ?instance_owl ?p13 ?admitted_source_concept_id_1.
    ?admitted_source_concept_id_1 owl:sameAs ?omop_p13.
    ?omop_p13 std:domain_id ?omop_domain_p13.
      FILTER(?omop_domain_p13="Visit")
      ?omop_p13 std:standard_concept_id ?admitted_source_concept_id_uri.
      ?admitted_source_concept_id_uri std:concept_id ?admitted_source_concept_id_uri.}
...
OPTIONAL{?p15 rdf:type omop:visit_detail_discharged_to_source_value.
    ?instance_owl ?p15 ?discharged_to_source_value_1.
    ?discharged_to_source_value_1 owl:sameAs ?omop_p15.
    ?omop_p15 std:domain_id ?omop_domain_p15.
      FILTER(?omop_domain_p15="Visit")
      ?omop_p15 std:concept_code ?discharged_to_source_value.}
OPTIONAL{?p16 rdf:type omop:visit_detail_discharged_to_concept_id.
    ?instance_owl ?p16 ?discharged_to_concept_id_1.
    ?discharged_to_concept_id_1 owl:sameAs ?omop_p16.
    ?omop_p16 std:domain_id ?omop_domain_p16.
      FILTER(?omop_domain_p16="Visit")
      ?omop_p16 std:standard_concept_id ?discharged_to_concept_id_uri.
      ?discharged_to_concept_id_uri std:concept_id ?discharged_to_concept_id.}
