...
OPTIONAL{?p13 rdf:type omop:admitting_source_concept_id.
    ...
    ?omop_p13 std:domain_id ?omop_domain_p13.
      ...
      ?admitting_source_concept_id_uri std:concept_id ?admitting_source_concept_id_uri.}
OPTIONAL{?p14 rdf:type omop:admitting_source_value.
